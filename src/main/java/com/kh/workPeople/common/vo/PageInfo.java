...
public class PageInfo {
	...
	private int userNo;			// 개인 마이페이지 쿼리문 작성시 필요한 유저번호.
	private String elName;		// 개인 마이페이지 쿼리문 작성시 필요한 업종명
	public PageInfo() {}
	...
	// 개인 마이페이지 관련 쿼리 조회시 사용할 객체의 생성자
	public PageInfo(int page, int listCount, int pageLimit, int boardLimit, int userNo) {
		super();
		this.page = page;
		this.listCount = listCount;
		this.pageLimit = pageLimit;
	...
	// 개인 마이페이지 관련 쿼리 조회시 사용할 객체의 생성자
	public PageInfo(int page, int listCount, int pageLimit, int boardLimit, String elName) {
		super();
		this.page = page;
		this.listCount = listCount;
		this.pageLimit = pageLimit;
